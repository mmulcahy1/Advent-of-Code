...
def calculate_calibration(test_value, current_value, remaining,):
    if len(remaining) == 0 and current_value == test_value:
        ...
        return calculate_calibration(test_value, current_value+remaining[0], remaining[1:]) or calculate_calibration(test_value, current_value*remaining[0], remaining[1:])
